                ...
                <div className="sortable-gallery overflow-hidden">
                    <div className="gallery-filters text-center mb-[60px]">
                        <ul className="inline-block overflow-hidden text-center">
                            <li onClick={() => setFilterKey('*')} className="inline-block col:mb-[5px] "><span className=" unactive-color font-normal block capitalize cursor-pointer">All</span></li>
                            <li onClick={() => setFilterKey('FamilyMatters')} className="inline-block ml-7 col:mb-[5px] col:ml-[10px]"><span className="unactive-color font-normal block capitalize cursor-pointer">Family Matters</span></li>
                            <li onClick={() => setFilterKey('RealEstate')} className="inline-block ml-7 col:mb-[5px] col:ml-[10px]"><span className="unactive-color font-normal block capitalize cursor-pointer">Real Estate</span></li>
                            <li onClick={() => setFilterKey('Business')} className="inline-block ml-7 col:mb-[5px] col:ml-[10px]"><span className="unactive-color font-normal block capitalize cursor-pointer">Business</span></li>
                            <li onClick={() => setFilterKey('Criminal')} className="inline-block ml-7 col:mb-[5px] col:ml-[10px]"><span className="unactive-color font-normal block capitalize cursor-pointer">Criminal</span></li>
                            <li onClick={() => setFilterKey('Injury')} className="inline-block ml-7 col:mb-[5px] col:ml-[10px]"><span className="unactive-color font-normal block capitalize cursor-pointer">Injury</span></li>
                        </ul>
                    </div>
                    ...
                    <div className="gallery-container gallery-fancybox masonry-gallery grid grid-cols-12 gap-4 filter-container">
                        {Cases.slice(0, 6).map((cases, i) => (
                            <div className={`filter-item max-w-[33.33%] md:max-w-[33.33%] sm:max-w-[50%] col:max-w-[100%] overflow-hidden grid-item  ${cases.filterName}`} key={i}>
