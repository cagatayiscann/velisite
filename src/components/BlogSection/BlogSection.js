                            ...
                            <div className="mb-[30px] group">
                                ...
                                <div className="bg-white pt-[20px] px-[20px] pb-[30px]">
                                    <h3 className="text-[24px] leading-[36px] font-heading-font font-medium mb-[20px]">
                                        <Link onClick={ClickHandler} to={`/blog-single/${blog.slug}`} className="text-[#000] transition ease-in-out duration-300 hover:text-[#c0b596]">{blog.title}</Link>
                                    </h3>
                                    <ul className="flex items-center">
                                        <li className="text-[#c0b596]"><img className="w-[40px] h-[40px] rounded-[50%]" src={blog.authorImg} alt="" /></li>
                                        <li className="text-[#c0b596] px-[10px]"><Link onClick={ClickHandler} to={`/blog-single/${blog.slug}`} className="text-[#666]">{blog.author}</Link></li>
