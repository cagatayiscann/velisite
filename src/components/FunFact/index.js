...
import cImg from '../../images/counter/1.jpg'
...
const FunFact = (props) => {
    ...
    return (
        ...
        <section className="relative z-1 bg-no-repeat bg-center bg-cover overflow-hidden pt-[100px] pb-[95px]" style={{ backgroundImage: `url(${cImg})` }}>
                        ...
                        <div className="counter-grids relative overflow-hidden">
                            {funFact.map((funfact, fitem) => (
                                <div className="w-[48%] float-left pt-[40px] pb-[40px] mr-[5px] bg-[#c0b59633] mb-[5px] text-center sm:flex-none col:w-full" key={fitem}>
                                    <div>
                                        <h2 className=" text-[50px] sm:text-[30px] font-bold text-white "><CountUp end={funfact.title} enableScrollSpy />{funfact.Symbol}</h2>
                                    </div>
