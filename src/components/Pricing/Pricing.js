               ...
               before:left-[50%] before:bottom-0 before:transform before:-translate-x-1/2 before:w-[60px] before:h-[3px]
                ...
                <div className="grid grid-cols-12 gap-3">
                    ...
                    group-hover:text-white">
                                ...
                                <Link to="/practice" className="transition-all ease-in-out group-hover:text-[#c0b596] group-hover:bg-white bg-[#c0b596] text-[16px] font-semibold text-white py-[10px] px-[38px] capitalize inline-block">Get Started</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-span-4 md:col-span-6 sm:col-span-12 mb-5">
