                        ...
                        {Attorneys.map((attorney, aitem) => (
                            <div className="overflow-hidden relative shadow-[1px_1px_5px_rgba(0,0,5,8%)] group" key={aitem}>
                                <div className="expert-img">
                                    <img className="w-full" src={attorney.AtImg} alt="" />
                                </div>
                                <div className="relative text-center mt-[-40px] bg-[#f5f5f5] transform translate-y-[40px] transition ease-in-out duration-300 group-hover:translate-y-0 group-hover:bg-[#fff]">
                                    <h3 className="text-[24px] col:text-[20px] font-medium pt-[30px] pb-[8px]  font-heading-font"><Link onClick={ClickHandler} to={`/attorneys-single/${attorney.slug}`} className="text-[#282e3f] hover:text-[#ada282] transition-all">{attorney.name} </Link></h3>
                                    ...
                                    <ul className="flex justify-center my-[20px] transition ease-in-out">
                                        <li className="px-[10px] "><Link onClick={ClickHandler} to={`/attorneys-single/${attorney.slug}`} className="text-[#c0b596] transition-all hover:text-[#999]"><i className="fa fa-facebook" aria-hidden="true"></i></Link></li>
                                        <li className="px-[10px] "><Link onClick={ClickHandler} to={`/attorneys-single/${attorney.slug}`} className="text-[#c0b596] transition-all hover:text-[#999]"><i className="fa fa-twitter" aria-hidden="true"></i></Link></li>
                                        <li className="px-[10px] "><Link onClick={ClickHandler} to={`/attorneys-single/${attorney.slug}`} className="text-[#c0b596] transition-all hover:text-[#999]"><i className="fa fa-linkedin" aria-hidden="true"></i></Link></li>
                                    </ul>
                                </div>
                            </div>
                        ))}
