  ...
  return (
    ...
    >
      ...
      <div className="text-center w-full mb-[10px]">
        <button
          type="submit"
          className="bg-[#c0b596] text-[#fff] inline-block py-[12px] px-[22px] border border-[#666] rounded-[55px] capitalize transition-all hover:bg-[#666] hover:border-transparent"
        >
          İletişime Geçin
        </button>
      </div>
